...
**Version 1.4.0** · Client presentation milestone · 2026-08-11 · `codex/adventure-4x8-today`
...
- H01-H08 now resolve authored hero skill VFX alpha sprites; H09-H20 remain truthfully marked `render_mode=procedural`.
