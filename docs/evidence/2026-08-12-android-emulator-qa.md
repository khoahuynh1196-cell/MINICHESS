...
- Screenshot: `tmp/android-api35-canonical-4x6-lobby-final.png`.
- Runtime memory sample: `TOTAL PSS 564907 KB`, `TOTAL RSS 763160 KB` after launch.
- `dumpsys gfxinfo` sample: 20 frames, 5 janky frames (25%), 50th percentile
  30 ms, 90th percentile 109 ms, 95th percentile 150 ms. This short emulator sample is diagnostic, not
