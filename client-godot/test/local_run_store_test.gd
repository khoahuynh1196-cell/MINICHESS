...
func _init() -> void:
	...
	_write_raw_json({ "schema_version": 2, "ruleset_version": "production-4x6-0.1.0", "view": stale_hero_choice })
	...
	_write_raw_json({ "schema_version": 2, "ruleset_version": "production-4x6-0.1.0", "view": non_hero_choice })
